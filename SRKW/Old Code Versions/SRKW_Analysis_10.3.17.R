...
FishRedux_Coastal$Oct_Apr <- (Kilos_Coastal[ ,2] - Kilos_Coastal[ ,6]) / Kilos_Coastal[ ,6]
FishRedux_Coastal$May_Jun <- (Kilos_Coastal[ ,3] - Kilos_Coastal[ ,7]) / Kilos_Coastal[ ,7]
FishRedux_Coastal$Jul_Sep <- (Kilos_Coastal[ ,5] - Kilos_Coastal[ ,8]) / Kilos_Coastal[ ,8]
