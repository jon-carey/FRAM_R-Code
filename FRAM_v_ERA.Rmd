...
## To-do
* add stocks?
* add functionality for 2:1 ERA:FRAM stocks?
* add tab to show age-specific ERs?
* pull ERs from TAMMs for PS stocks?
* compare BYERs?
* figure out a better way to handle stocks with mat rates in more than one time step
    ...
    if(is.na(OUT_dat)[1] == FALSE) {
      for(k in 1:length(OUT_dat)) {
        if(OUT_dat[k] == "FISHERY SPECIFIC EXPLOITATION RATES (LESS NATURAL MORTALITY)<TERMINAL AREAS=PROPORTION OF TERMINAL RUN ONLY>") {
          mat_ref <- k
          aeq_ref <- k
          if(stk %in% c("SAM","SSF","SRH","QUE","HOK")) {
            mat_ref <- k+1
            aeq_ref <- k+2
          }
        }
...
####`r stk_info[i,1]`
```{r stk1, fig.width=8, echo=FALSE, message=FALSE, warning=FALSE}
...
####`r stk_info[i,1]`
```{r stk2, fig.width=8, echo=FALSE, message=FALSE, warning=FALSE}
tagtable <- BP_tagcodes[BP_tagcodes$Stock == StkList[i], ]
kable(tagtable, align = 'ccccc', row.names = F) %>%
  kable_styling(full_width = F, bootstrap_options = c("striped", "hover"))
...
####`r stk_info[i,1]`
```{r stk3, fig.width = 8, echo=FALSE, message=FALSE, warning=FALSE}
tagtable <- BP_tagcodes[BP_tagcodes$Stock == StkList[i], ]
kable(tagtable, align = 'ccccc', row.names = F) %>%
  kable_styling(full_width = F, bootstrap_options = c("striped", "hover"))
...
####`r stk_info[i,1]`
```{r stk4, fig.width = 8, echo=FALSE, message=FALSE, warning=FALSE}
tagtable <- BP_tagcodes[BP_tagcodes$Stock == StkList[i], ]
kable(tagtable, align = 'ccccc', row.names = F) %>%
  kable_styling(full_width = F, bootstrap_options = c("striped", "hover"))
...
####`r stk_info[i,1]`
```{r stk5, fig.width = 8, echo=FALSE, message=FALSE, warning=FALSE}
tagtable <- BP_tagcodes[BP_tagcodes$Stock == StkList[i], ]
kable(tagtable, align = 'ccccc', row.names = F) %>%
  kable_styling(full_width = F, bootstrap_options = c("striped", "hover"))
...
####`r stk_info[i,1]`
```{r stk6, fig.width = 8, echo=FALSE, message=FALSE, warning=FALSE}
tagtable <- BP_tagcodes[BP_tagcodes$Stock == StkList[i], ]
kable(tagtable, align = 'ccccc', row.names = F) %>%
  kable_styling(full_width = F, bootstrap_options = c("striped", "hover"))
...
####`r stk_info[i,1]`
```{r stk7, fig.width = 8, echo=FALSE, message=FALSE, warning=FALSE}
tagtable <- BP_tagcodes[BP_tagcodes$Stock == StkList[i], ]
kable(tagtable, align = 'ccccc', row.names = F) %>%
  kable_styling(full_width = F, bootstrap_options = c("striped", "hover"))
...
####`r stk_info[i,1]`
```{r stk8, fig.width = 8, echo=FALSE, message=FALSE, warning=FALSE}
tagtable <- BP_tagcodes[BP_tagcodes$Stock == StkList[i], ]
kable(tagtable, align = 'ccccc', row.names = F) %>%
  kable_styling(full_width = F, bootstrap_options = c("striped", "hover"))
...
####`r stk_info[i,1]`
```{r stk9, fig.width = 8, echo=FALSE, message=FALSE, warning=FALSE}
tagtable <- BP_tagcodes[BP_tagcodes$Stock == StkList[i], ]
kable(tagtable, align = 'ccccc', row.names = F) %>%
  kable_styling(full_width = F, bootstrap_options = c("striped", "hover"))
...
####`r stk_info[i,1]`
```{r stk10, fig.width = 8, echo=FALSE, message=FALSE, warning=FALSE}
tagtable <- BP_tagcodes[BP_tagcodes$Stock == StkList[i], ]
kable(tagtable, align = 'ccccc', row.names = F) %>%
  kable_styling(full_width = F, bootstrap_options = c("striped", "hover"))
...
####`r stk_info[i,1]`
```{r stk11, fig.width = 8, echo=FALSE, message=FALSE, warning=FALSE}
tagtable <- BP_tagcodes[BP_tagcodes$Stock == StkList[i], ]
kable(tagtable, align = 'ccccc', row.names = F) %>%
  kable_styling(full_width = F, bootstrap_options = c("striped", "hover"))
...
####`r stk_info[i,1]`
```{r stk12, fig.width = 8, echo=FALSE, message=FALSE, warning=FALSE}
tagtable <- BP_tagcodes[BP_tagcodes$Stock == StkList[i], ]
kable(tagtable, align = 'ccccc', row.names = F) %>%
  kable_styling(full_width = F, bootstrap_options = c("striped", "hover"))
...
####`r stk_info[i,1]`
```{r stk13, fig.width = 8, echo=FALSE, message=FALSE, warning=FALSE}
tagtable <- BP_tagcodes[BP_tagcodes$Stock == StkList[i], ]
kable(tagtable, align = 'ccccc', row.names = F) %>%
  kable_styling(full_width = F, bootstrap_options = c("striped", "hover"))
...
####`r stk_info[i,1]`
```{r stk14, fig.width = 8, echo=FALSE, message=FALSE, warning=FALSE}
tagtable <- BP_tagcodes[BP_tagcodes$Stock == StkList[i], ]
kable(tagtable, align = 'ccccc', row.names = F) %>%
  kable_styling(full_width = F, bootstrap_options = c("striped", "hover"))
...
####`r stk_info[i,1]`
```{r stk15, fig.width = 8, echo=FALSE, message=FALSE, warning=FALSE}
tagtable <- BP_tagcodes[BP_tagcodes$Stock == StkList[i], ]
kable(tagtable, align = 'ccccc', row.names = F) %>%
  kable_styling(full_width = F, bootstrap_options = c("striped", "hover"))
